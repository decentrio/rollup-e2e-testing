...
require (
	...
	github.com/rollkit/rollkit v0.12.0-rc0 // indirect
...
replace github.com/cosmos/cosmos-sdk => github.com/rollkit/cosmos-sdk v0.50.1-rollkit-v0.12.0-rc0-no-fraud-proofs
